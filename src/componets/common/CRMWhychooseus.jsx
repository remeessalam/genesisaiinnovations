      ...
      <div className="wrapper text-center text-primarytextcolor flex flex-col gap-7">
        ...
        <div className="flex flex-col gap-5">
          <h2 data-aos-offset={-200} data-aos="fade-up" className="heading-2">
            The Driving Force Behind Our AI-Powered CRM Solutions{" "}
          </h2>
          <p
            data-aos-offset={-200}
            data-aos="fade-up"
          ...
          >
            At Genesis AI, we’re committed to delivering CRM solutions that go
            beyond expectations. Our team of experts collaborates with you to
            transform your customer management challenges into opportunities for
            growth.
          </p>
          {/* <div
            data-aos-offset={-400}
            ...
            <div className="flex flex-col gap-5">
              ...
              >
                ...
                <p className="desc text-primarytextcolor text-start mt-3">
                  Proven expertise in building tailored, intelligent CRM systems
              ...
              >
                ...
                <p className="desc text-primarytextcolor text-start mt-3">
                  Adaptive solutions designed to evolve with your business
                  needs, ensuring sustained success.
                </p>
              </div>
            </div>
            <div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 max-w-[60rem] ml-auto">
            ...
            <div className="flex flex-col gap-5 h-full">
              ...
              >
                ...
                <p className="desc text-primarytextcolor text-start mt-3">
                  Transparent and collaborative communication, fostering trust
              ...
              >
                ...
                <p className="desc text-primarytextcolor text-start mt-3">
                  Robust security measures and compliance protocols to safeguard
                  customer data and ensure regulatory adherence.
                </p>
              </div>
            </div>
          </div>
